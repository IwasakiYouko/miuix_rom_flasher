...
private fun detectAppRuntimeBaseDir(): String = memScoped {
    ...
    // length == 0 means failure; length >= bufferSize means the path was truncated. In every
    // other case GetModuleFileNameW NUL-terminates the buffer, so toKStringFromUtf16 is safe.
